...
Si vous souhaitez comprendre l'IA en général et l'IA générative en particulier et avoir une vision globale pour commencer, je vous conseille de lire mes articles sur [comprendre l'IA](comprendre-l-IA-guide.md) et [comprendre l'IA générative](comprendre-l-IA-generative.md). Pour replacer l'IA générative dans son écosystème (vision, NLP, séries temporelles, données tabulaires…), j'ai aussi écrit un tour d'horizon des [différents domaines de l'intelligence artificielle](domaines-intelligence-artificielle.md).

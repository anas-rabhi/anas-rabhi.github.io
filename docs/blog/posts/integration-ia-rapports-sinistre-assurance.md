...
description: "Cas client : comment on automatise les rapports de sinistre en assurance avec l'IA, une interface métier et l'humain dans la boucle."
categories:
  - "Blog"
  - "IA"
  - "Cas d'usage"
...
**Vous avez un process métier répétitif qui prend des heures ?** L'approche qu'on a utilisée ici (IA + interface + humain dans la boucle) est applicable à beaucoup de cas similaires : rapports techniques, comptes-rendus, audits, fiches produit... [Réservez un créneau](https://cal.com/anas-rabhi/ianas) pour en discuter, ou écrivez-moi à [anas0rabhi@gmail.com](mailto:anas0rabhi@gmail.com).

...
Cette personnalisation passe d'ailleurs par une brique qu'on remarque à peine : la mémoire. Si vous vous êtes déjà demandé [comment ChatGPT et Claude se souviennent de vous d'une conversation à l'autre](comment-chatgpt-se-souvient-de-vous.md), la réponse découle directement de ce qu'on vient de voir : le modèle, lui, est figé et ne retient rien ; c'est une couche posée par-dessus qui stocke des informations et les réinjecte au bon moment.

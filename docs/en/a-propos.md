...
description: Anas Rabhi, freelance AI engineer based in Toulouse. Specialized in RAG, AI agents, NLP and LLMOps. Production AI systems that deliver measurable results.
hide:
  - navigation
  - toc
---
...
- **RAG** (Retrieval-Augmented Generation) — hybrid BM25 + vector retrieval, reranking, chunking, quality evaluation. This is the core of most of my projects. I write about it regularly on the [blog](/en/blog/).
...
**[Tensoria](https://tensoria.fr/)** is my AI consulting firm. I work there on a time-and-materials or fixed-price basis for scoping, prototyping, RAG audits, production deployment and data team coaching. Primarily in Toulouse and remote. The first conversation is always free.

**[Heeya](https://heeya.fr/)** is a product born from a recurring client pattern: deploy a personalised RAG chatbot on any website, trained on its own content, in a few clicks. A turnkey solution for companies that want an AI assistant without building a data team.
...
These figures come from real projects, not estimates. I detail them when relevant in articles on the [blog](/en/blog/).
...
- [Optimising your RAG: the 8 techniques that really make a difference](/en/blog/2026/04/22/optimiser-rag-techniques/) — HyDE, reranking, contextual retrieval, semantic cache.
- [Optimal chunking for your RAG](/en/blog/2026/04/15/chunking-optimal-rag/) — 8 strategies compared, real benchmarks.
- [Training, fine-tuning or RAG: which to choose for your AI?](/en/blog/2026/05/02/entrainement-finetuning-rag-modele-ia/) — complete decision tree with cost estimates.
...
[:material-home: Back to home](/en/){ .md-button }
...
<script type="application/ld+json">
{
  ...
  "@type": "Person",
  "name": "Anas Rabhi",
  "url": "https://ianas.fr/en/a-propos/",
  "image": "https://ianas.fr/assets/og-image.png",
  "jobTitle": "Freelance AI Engineer & Data Scientist",
  "description": "Freelance Data Scientist based in Toulouse, France, specialized in RAG, AI agents, NLP and LLMOps. Founder of Tensoria and Heeya.",
  "worksFor": {
    "@type": "Organization",
    "name": "Tensoria",

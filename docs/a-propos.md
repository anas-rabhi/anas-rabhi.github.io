---
title: À propos — Anas Rabhi, Consultant IA & Data Scientist Freelance à Toulouse
description: Anas Rabhi, consultant IA freelance à Toulouse. Data Scientist spécialisé RAG, agents IA, NLP et LLMOps. Découvrez mon parcours, ma méthode et mes projets. →
hide:
  - navigation
  - toc
---
...
- **RAG** (Retrieval-Augmented Generation) — retrieval hybride BM25 + vectoriel, reranking, chunking, évaluation de la qualité. C'est le coeur de la majorité de mes missions. J'écris régulièrement dessus sur le [blog](/blog/).
...
Sur les projets complexes, je m'appuie aussi sur des [notebooks d'exploration](/notebooks/) pour valider les hypothèses avant de coder une solution complète.

---

## Mes deux structures

**[Tensoria](https://tensoria.fr/)** est ma structure de conseil en IA. J'y interviens en régie ou au forfait pour des missions de cadrage, prototypage, audit RAG, mise en production et accompagnement d'équipes data. Principalement à Toulouse et en remote. Le premier échange est toujours gratuit.

**[Heeya](https://heeya.fr/)** est un produit né d'un cas client récurrent : déployer un chatbot RAG personnalisé sur n'importe quel site, formé sur son propre contenu, en quelques clics. Une solution clé en main pour les entreprises qui veulent un assistant IA sans monter une équipe data.
...
Ces chiffres sont issus de projets réels, pas d'estimations. Je les détaille quand c'est pertinent dans les articles du [blog](/blog/).
...
- [Optimiser son RAG : les 8 techniques qui font vraiment la différence](/blog/2026/04/22/optimiser-rag-techniques/) — HyDE, reranking, contextual retrieval, semantic cache.
- [Chunking optimal pour votre RAG](/blog/2026/04/15/chunking-optimal-rag/) — 8 stratégies comparées, benchmarks réels.
- [Entraînement, finetuning ou RAG : que choisir pour son IA ?](/blog/2026/05/02/entrainement-finetuning-rag-modele-ia/) — arbre de décision complet avec ordres de grandeur de coûts.
...
-   :fontawesome-brands-x-twitter:{ .lg .middle } __X / Twitter__
    ...
    [x.com/anas9r](https://x.com/anas9r)
...
<script type="application/ld+json">
{
  ...
  "image": "https://ianas.fr/assets/og-image.png",
  "jobTitle": "Consultant IA & Data Scientist Freelance",
  "description": "Data Scientist freelance à Toulouse, spécialisé RAG, agents IA, NLP et LLMOps. Fondateur de Tensoria et Heeya.",
  "worksFor": {
    "@type": "Organization",
    "name": "Tensoria",
    "url": "https://tensoria.fr/"
  },
  "address": {
    "@type": "PostalAddress",
